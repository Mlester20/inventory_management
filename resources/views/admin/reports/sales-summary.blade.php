...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="row mb-4">
        <div class="col-12">
            <h4 class="mb-1">Sales Summary Report</h4>
            <p class="text-muted">Aggregate sales from the Sales Invoice ledger</p>
        </div>
    </div>
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form method="GET" action="{{ route('admin.reports.sales-summary') }}" class="row g-3">
                <div class="col-md-3">
                ...
                <div class="col-md-3 d-flex align-items-end gap-2">
                    ...
                    <a href="{{ route('admin.reports.sales-summary') }}" class="btn btn-outline-secondary" title="Clear all filters">
    ...
    <div class="row mb-4">
        <div class="col-12 col-md-4">
            <div class="card bg-light-primary border-primary">
                <div class="card-body">
                    <span class="text-muted d-block mb-2 small">Total Sales Amount</span>
        ...
        <div class="col-12 col-md-4">
            <div class="card">
                <div class="card-body">
                    <span class="text-muted d-block mb-2 small">Total Qty Sold</span>
